...
{
    public class StatefulServiceBase : StatefulService, IService
    {
        public StatefulServiceBase(StatefulServiceContext serviceContext) : base(serviceContext)
        {
        }

        public StatefulServiceBase(StatefulServiceContext serviceContext, IReliableStateManagerReplica2 reliableStateManagerReplica) : base(serviceContext, reliableStateManagerReplica)
        {
        }
        ...
        {
            var dictionary =
                await StateManager.GetOrAddAsync<IReliableDictionary<string, T>>(dictionaryKey);
