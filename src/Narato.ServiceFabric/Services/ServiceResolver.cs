...
namespace Narato.ServiceFabric.Services
{
...

    {
        ...
        {
            _proxyFactory = new ServiceProxyFactory((c) => new FabricTransportServiceRemotingClientFactory());
        }

        public virtual TServiceType Resolve<TServiceType>(ServiceDefinition serviceDefinition)
        ...
        public virtual TServiceType Resolve<TServiceType>(Uri serviceUri)
            where TServiceType : IService
        {
